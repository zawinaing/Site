    ...
    <footer className="bg-[#05134b] px-20 pb-20 pt-12 flex flex-shrink-0 gap-28 h-full relative">
      ...
      <nav className="flex flex-col">
        <label aria-hidden htmlFor="#">
          <strong className="text-white font-serif tracking-wide">Navigation</strong>
        </label>
      ...
      <div>
        <label aria-hidden htmlFor="#">
          <strong className="text-white font-serif tracking-wide">Specialties</strong>
        </label>
      ...
      <div className="flex flex-col items-start">
        <label aria-hidden htmlFor="#">
          <strong className="text-white font-serif tracking-wide">Portals</strong>
        </label>
        ...
        <a href="https://www.esupralife.com/login" className="w-full">
          <button className="group mt-5 w-full rounded-[40px] bg-[#2A4C93] hover:bg-[#476cbd] active:bg-[#192c55] px-3 py-4 inline-flex items-center justify-between gap-2 font-poppins tracking-widest">
            <div className="group text-white text-xs font-semibold">Login</div>
            <div className="group-hover:translate-x-2 transition-transform duration-200">
              <ChevronIcon />
            </div>
          </button>
      ...
      <nav className="flex flex-col">
        <label aria-hidden htmlFor="#">
          <strong className="text-white font-serif tracking-wide">Legal</strong>
        </label>

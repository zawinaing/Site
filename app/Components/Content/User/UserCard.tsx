...
export default function UserCard() {
  return (
    <article className="flex bg-gray-300 rounded-[5px] space-x-3 h-[280px]">
      <div className="px-3 py-2 flex flex-shrink-0 gap-3 rounded-[5px] justify-between">
        <div className="flex flex-col items-center justify-center bg-stone-200 p-5 rounded-[inherit] border border-gray-400/60">
          {/* TODO Live icon */}
          <Image
            width={100}
            height={50}
        ...
        <div className="min-w-[680px] group bg-stone-200 p-5 rounded-[inherit] border border-gray-400/60 space-y-3 relative">
          ...
          <div className="uppercase font-medium text-stone-500 text-xs flex">
            ...
            <div className="not-last:border-r-2 not-last:border-r-blue-500 px-1 uppercase text-blue-600 font-semibold tracking-wide">
              vascular neurology
            </div>
            <div className="not-last:border-r-2 not-last:border-r-blue-500 px-1 uppercase text-blue-600 font-semibold tracking-wide">
              headache medicine
        ...
        <div className="w-fit border-l border-l-gray-400/60 pl-5 flex flex-shrink-0 gap-3 justify-between">
          ...
          <div className="flex flex-col justify-between">
            <Options
              ...
              icon={<CalendarIcon />}
            />
            <Options color="blue" text="View Profile" />
            <Options color="slateblue" text="Order" />
            <Options color="slateblue" text="Invite to Bid" />
            <Options color="slateblue" text="Propose Price Match" />
            <Options color="yellow" text="Enquire" />
          </div>
        </div>
      </div>
    </article>
